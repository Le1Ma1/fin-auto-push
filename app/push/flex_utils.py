    ...
    bubble_hist = {
        ...
        "body": {
            ...
            "contents": [
                ...
                {"type": "text", "text": f"最大單日淨流入：{human_unit(max_in_hist)}（{max_in_date_hist}）", "size": "sm", "color": "#00b300"},
                {"type": "text", "text": f"最大單日淨流出：{human_unit(max_out_hist)}（{max_out_date_hist}）", "size": "sm", "color": "#D50000"},
                {"type": "text", "text": f"中位數：{human_unit(nonzero_median_hist)}", "size": "sm", "color": "#F5FAFE"},
                {"type": "text", "text": f"平均值：{human_unit(mean_hist)}", "size": "sm", "color": "#F5FAFE"}
            ]
        }
    }
